...
public class TestScript_LN1 extends Base_Test {
		...
		public void login(String email,String pwd) throws InterruptedException {
			...
			WebElement h1=driver.findElement(By.xpath("//strong[text()='Sign In']"));
			Assert.assertTrue(h1.isDisplayed(),"not clicking on Signin");
